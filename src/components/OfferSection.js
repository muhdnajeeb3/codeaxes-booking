        ...
        <Row className="carosel">
          ...
          <div>
            ...
            <Slider {...settings} className="sliderrow">
              <div>
                <Card style={{ width: "30rem",height:"13rem",marginLeft:"2rem" }} className="cards">
                  ...
                  <Card.Body>
                    ...
                    <Row style={{ width:"8rem",top:"2.7rem" }} className="booknowrow"><Button variant="" className="booknowbtn">Book Now</Button></Row>
                    
                  </Card.Body>
                </Card>
              </div>
              <div>
              <Card style={{ width: "30rem",height:"13rem",marginLeft:"0rem" }} className="cards">
                  ...
                  <Card.Body>
                    ...
                    <Row style={{ width:"8rem" }} className="booknowrow"><Button variant="" className="booknowbtn">Book Now</Button></Row>
                  </Card.Body>
                </Card>
              </div>
              <div>
              <Card style={{ width: "30rem",height:"13rem",marginLeft:"2rem" }} className="cards">
                  <Card.Img variant="top" src="https://promos.makemytrip.com/notification/xhdpi//116x116-ExtraBaggage-05092022.jpg" className="img"/>
                  <Card.Body>
                    {/* <h6>DOM FLIGHTS</h6> */}
                    {/* <Card.Title>DOM FLIGHTS</Card.Title> */}
                    <h5>Carry Extra Baggage @20%* Lower Prices!</h5>
                    <Card.Text className="cardtext">
                      Now purchase EXCESS BAGGAGE allowance in advance & save BIG bucks on your journey.
                    </Card.Text>
                    <Row style={{ width:"8rem" }} className="booknowrow"><Button variant="" className="booknowbtn">Book Now</Button></Row>
                  </Card.Body>
                </Card>
              ...
              <div>
              <Card style={{ width: "30rem",height:"13rem",marginLeft:"2rem" }} className="cards">
                  <Card.Img variant="top" src="https://promos.makemytrip.com/notification/xhdpi//AncillaryMeals-01092022.jpg" className="img"/>
                  <Card.Body>
                    {/* <h6>DOM FLIGHTS</h6> */}
                    {/* <Card.Title>DOM FLIGHTS</Card.Title> */}
                    <h5>Meals for Your Flights @ uo to 20% Lower Prices!</h5>
                    <Card.Text className="cardtext">
                      Now book your meal in advance & save BIG bucks on your journey.
                    </Card.Text>
                    <Row style={{ width:"8rem" }} className="booknowrow"><Button variant="" className="booknowbtn">Book Now</Button></Row>
                  </Card.Body>
                </Card>
              ...
              <div>
              <Card style={{ width: "30rem",height:"13rem",marginLeft:"2rem" }} className="cards">
                  <Card.Img variant="top" src="https://promos.makemytrip.com/notification/xhdpi//mobikwik011022.jpeg" className="img"/>
                  <Card.Body>
                    {/* <Card.Title>DOM FLIGHTS</Card.Title> */}
                    <h5>It's the Seoson of #DiscountDEALLights!</h5>
                    <Card.Text className="cardtext">
                      Pay with Mobikwik & grab up to Rs. 600 OFF* on Domesticflights,hotels,bus booking.
                      
                    </Card.Text>
                    <Row style={{ width:"8rem", }} className="booknowrow"> <Button variant="" className="booknowbtn"> View Details</Button></Row>
                  </Card.Body>
                </Card>
              </div>
              <div>
              <Card style={{ width: "30rem",height:"13rem",marginLeft:"2rem" }} className="cards">
                  <Card.Img variant="top" src="https://promos.makemytrip.com/notification/xhdpi//116X116-if-thailand-27092022.jpg" className="img"/>
                  <Card.Body>
                    <h5>Travel Restrictions Eased for Thailand!</h5>
                    <Card.Text className="cardtext">
                      Now explore Thailand without worrying about rapid-antigen test.Thailand pass or travel insurance. .
                    </Card.Text>
                    <Row style={{ width:"8rem",bottom:"31rem" }} className="booknowrow"><Button variant="" className="booknowbtn">Book Now</Button></Row>
                  </Card.Body>
                </Card>
              </div>
              <div>
              <Card style={{ width: "30rem",height:"13rem",marginLeft:"2rem" }} className="cards">
                  <Card.Img variant="top" src="https://promos.makemytrip.com/notification/xhdpi//health-professionals-116x116-06092022.jpg" className="img"/>
                  <Card.Body>
                    <h5>INTRODUCED: Special Fares for Healthcare  Profession...</h5>
                    <Card.Text className="cardtext">
              ...
              <div>
              <Card style={{ width: "30rem",height:"13rem",marginLeft:"2rem" }} className="cards">
                  <Card.Img variant="top" src="https://promos.makemytrip.com/notification/xhdpi//116X116-jazeera-26092022.jpg" className="img"/>
                  <Card.Body>
              ...
              <div>
              <Card style={{ width: "30rem",height:"13rem",marginLeft:"2rem" }} className="cards">
                  <Card.Img variant="top" src="https://promos.makemytrip.com/notification/xhdpi//116X116-MMT-Group-230522.jpg" className="img"/>
                  <Card.Body>
                    <h5>For You: Group Booking Benefits on Flights FLIGHTS</h5>
              ...
              <div>
              <Card style={{ width: "30rem",height:"13rem",marginLeft:"2rem" }} className="cards">
                  <Card.Img variant="top" src="https://promos.makemytrip.com/notification/xhdpi//Flash_Sale_Flights.jpg" className="img"/>
                  <Card.Body>
